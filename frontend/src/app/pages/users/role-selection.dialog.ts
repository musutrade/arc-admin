...
@Component({
  ...
  template: `
    <form class="editor-dialog compact-dialog" [formGroup]="form" (ngSubmit)="submit()">
      ...
      <p class="dialog-message">The selected roles will replace existing assignments.</p>
      <div class="form-field">
        <label for="selected-roles">Roles</label>
      ...
      <div class="dialog-actions">
        ...
        <button type="submit" class="btn-primary">Apply Roles</button>
      </div>
    </form>
  `,
